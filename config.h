...
const string DYNAMIC_SS_QUEUE_WORKLOAD="dynamic-ss-queue-workload";
const string DYNAMIC_SS_TEST_VIC_NUM="dynamic-ss-test-vic-num";
const string DYNAMIC_SS_QUEUE_WORKLOAD_PARALLEL="dynamic-ss-queue-workload-parallel";
const string DYNAMIC_SS_QUEUE_WORKLOAD_PARALLEL_SHUFFLING="dynamic-ss-queue-workload-parallel-shuffling";
...
public:
    ...
    double query_arrRate;
    double update_arrRate;
    double queue_time=1000;
	unsigned int check_size = 0;
    unsigned int check_from = 500;
    //--------------------------PFS------------
    unsigned int total_worker_num;
    unsigned int total_shuffling_controller_num;
    unsigned int degree_shuffling_PFS=1;
    double beta_PFS=0.5;
    //----------------------------------------
